...
note that every number has 1 and itself as a factor. 
and if it has multiple times of a factor it only counted once.
...
and we can get it simply by calculate the square root of that number. 
of course the decimal part is eliminated.
*/
